...
<%
	...
	<div>
		...
		<div class="table table-striped" style="margin-left: 340px; margin-right: 40px; width: 60%;">
			<form action="/blog1/BoardWrite.do" method="post">
				...
				<div class="w3-margin-bottom w3-border">
					<input type="text" name="board_subject" class="form-control" autofocus placeholder="subject">
				</div>
				<div>
				...
				<div align="center">
					...
					<input type="button" value="취소" class="btn btn-primary pull-right" onclick="history.go(-1)">
				</div>
			</form>
		</div>
	</div>
